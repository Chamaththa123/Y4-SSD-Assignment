  ...
  return (
    <div className="signin-signup-cpt-frame">
      <form onSubmit={handleLogin}>
        ...
        <button type="submit" className="signin-signup-btn" style={{cursor:'pointer'}}>
          Sign in
        </button>
        <br/>
        <br/>
...
<button class="button22">
  <svg className="button-svg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 262">
